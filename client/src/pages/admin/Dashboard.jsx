...
const Dashboard = () => {
  ...
  return (
    <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 ">
      ...
      {/* Course Prices Card */}
      <Card className="overflow-x-hidden md:overflow-hidden w-full shadow-lg hover:shadow-xl transition-shadow duration-300 col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-4">
        <CardHeader>
